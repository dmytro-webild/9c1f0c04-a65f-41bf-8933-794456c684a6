...
export const metadata: Metadata = {
  title: "Kenzie Plumbing | 24/7 Emergency Plumbing in Hobbs, NM",  description: "Fast, fair plumbing service in Hobbs & Seminole. Emergency repairs, leak detection, water line service. 24/7 available. Trusted local plumbers.",  keywords: "plumbing service Hobbs NM, emergency plumber, leak detection, water line repair, sewer service, Seminole",  openGraph: {
    title: "Kenzie Plumbing | 24/7 Emergency Plumbing",    description: "Reliable plumbing service for Hobbs and surrounding areas. Fast response, honest pricing, professional technicians.",    siteName: "Kenzie Plumbing",    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Kenzie Plumbing | Local 24/7 Service",    description: "Fast, fair plumbing repair in Hobbs, NM. Emergency available anytime."},
  robots: {
    index: true,
    follow: true,
  },
